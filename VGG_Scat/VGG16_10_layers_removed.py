...
class Scattering2dVGG(nn.Module):
    ...
    def build(self):
        ...
        self.vgg.features = nn.Sequential(*list(self.vgg.features[10:]))
        self.vgg.features[0] = nn.Conv2d(self.scattering_output_channels, 256, kernel_size=3, stride=1, padding=1)
...
for epoch in range(0, num_epoch):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), f'VGG16_10_layers_removed_epoch_{epoch+1}.pth')
