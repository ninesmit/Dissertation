...
class Scattering2dDenseNet(nn.Module):
    ...
    def build(self):
        ...
        self.dense.features.conv0 = nn.Conv2d(self.scattering_output_channels, 64, kernel_size=7, stride=2, padding=3)
...
for epoch in range(0, num_epoch):
    ...
    if (epoch + 1) % 20 == 0:
        torch.save(model.state_dict(), f'DenseNet_epoch_{epoch+1}.pth')
